...
class ActorEvents_30 extends ActorScript
{
	...
	override public function init()
	{
		...
		/* ======================== When Creating ========================= */
		/* this  prevents the hero from freezing if he Exits the screen  */
		...
		addWhenUpdatedListener(null, function(elapsedTime:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				Engine.engine.setGameAttribute("ice cream x", actor.getXVelocity());
				Engine.engine.setGameAttribute("ice cream y", actor.getYVelocity());
			}
		});
